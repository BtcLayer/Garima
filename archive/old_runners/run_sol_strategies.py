"""
Run all strategies on SOLUSDT - All Timeframes (15m, 1h, 4h)
...
DATA_FILES = {
    "15m": "SOLUSDT_15m_2025-03-17_2026-03-17.parquet",
    "1h": "SOLUSDT_1h_2025-03-17_2026-03-17.parquet",
    "4h": "SOLUSDT_4h_2025-03-17_2026-03-17.parquet",
}
...
def load_data(timeframe):
    ...
    print(f"Fetching SOLUSDT {timeframe} data from Binance...")
    try:
        ...
        save_path = os.path.join(DATA_DIR, f"SOLUSDT_{timeframe}_2025-03-17_2026-03-17.parquet")
        ...
        print(f"Could not fetch SOLUSDT data: {e}")
...
def run_all():
    ...
    print("="*60)
    print("SOLUSDT - Testing ALL Strategies on ALL Timeframes")
    print("="*60)
    ...
    if len(results) > 0:
        ...
        df_results.to_csv("sol_all_results.csv", index=False)
        ...
        print("\n⚠️ No results generated - no data available for SOLUSDT")
        cols = ["Rank", "Strategy", "Asset", "Timeframe", "Initial_Capital_USD", 
                "Final_Capital_USD", "Net_Profit_USD", "roi", "ROI/annum", 
                "ROI_per_annum_Percent", "Total_Trades", "Winning_Trades", 
                "Losing_Trades", "Win_Rate_Percent", "Profit_Factor", 
                ...
                "Deployment_Status", "Data_Source", "Time_period_checked",
                "Time_start", "time_end", "fees_exchnage", "Parameters", "Candle_Period"]
        pd.DataFrame(columns=cols).to_csv("sol_all_results.csv", index=False)
