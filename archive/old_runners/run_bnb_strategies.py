"""
Run all strategies on BNBUSDT - All Timeframes (15m, 1h, 4h)
...
DATA_FILES = {
    "15m": "BNBUSDT_15m_2025-03-17_2026-03-17.parquet",
    "1h": "BNBUSDT_1h_2025-03-17_2026-03-17.parquet",
    "4h": "BNBUSDT_4h_2025-03-17_2026-03-17.parquet",
}
...
def run_all():
    ...
    print("="*60)
    print("BNBUSDT - Testing ALL Strategies on ALL Timeframes")
    print("="*60)
    ...
    if len(results) > 0:
        ...
        df_results.to_csv("bnb_all_results.csv", index=False)
