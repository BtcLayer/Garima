"""
Run all strategies on BTCUSDT - All Timeframes (15m, 1h, 4h)
...
DATA_FILES = {
    "15m": "BTCUSDT_15m_2025-03-17_2026-03-17.parquet",
    "1h": "BTCUSDT_1h_2025-03-17_2026-03-17.parquet",
    "4h": "BTCUSDT_4h_2025-03-17_2026-03-17.parquet",
}
...
def run_backtest_detailed(df, sl, tp, ts):
    ...
    return {
        ...
        "roi": round(roi, 2),
        "roi_annum": round(roi * 100, 2),
        "roi_per_annum_percent": round(roi * 100, 2),
...
def run_all():
    ...
    print("="*60)
    print("BTCUSDT - Testing ALL Strategies on ALL Timeframes")
    print("="*60)
